...
const PropertyDetails = () => {
  ...
  const { queryResult } = useShow(); //refine checks our url and knows we are on /properties/show/id grabs the id and makes a call to our backend and grabs what we need
  ...
  return (
    <Box borderRadius="15px" padding="20px" bgcolor="#FCFCFC" width="95%">
            ...
            >
              ...
              <Box>
                ...
                <Stack direction="row" alignItems="flex-end" gap={1}>
                  <Typography fontSize={25} fontWeight={700} color="#b77b82">
          ...
          >
            ...
            >
              ...
              <CustomButton
                ...
                backgroundColor={!isCurrentUser ? "#63c795" : "#cb4c4c"}
                color="#FCFCFC"
                fullWidth
